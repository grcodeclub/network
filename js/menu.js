$(document).ready(function() {
    ...
    menuLink = '<li><a href="https://grcodeclub.gr/network/more/list/application-and-protocols">Εφαρμογή και Πρωτόκολλο</a></li>';
    $('.sidebarMenuInner').append(menuLink);

    menuLink = '<li><a href="https://grcodeclub.gr/network/orologia">Ορολογία</a></li>';
    $('.sidebarMenuInner').append(menuLink);
    
    menuLink = '<li><a href="https://grcodeclub.gr/network/more">Έγγραφα</a></li>';
    $('.sidebarMenuInner').append(menuLink);

    menuLink = '<li><a href="https://grcodeclub.gr/network/cloud/">Cloud</a></li>';
    $('.sidebarMenuInner').append(menuLink);
